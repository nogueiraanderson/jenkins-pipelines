...
Starting cluster creation process...
                    ...
                    // Set build description early
                    currentBuild.description = "${env.FINAL_CLUSTER_NAME} - ${params.AWS_REGION} (${params.OPENSHIFT_VERSION})"
                }
            }
        }
...
Failure Stage:        ${env.STAGE_NAME ?: 'Unknown'}"""
